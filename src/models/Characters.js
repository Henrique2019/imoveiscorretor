export const Characters = [
  {
    ...
    id2:"bardock2",
    id3:"bardock3",
    foto1:"https://cdn.pixabay.com/photo/2017/04/10/22/28/residence-2219972__340.jpg",
    name: "Soft Jardim américa",
    description:
      "Estágio da Obra: Breve Lançamento | Início em: 2022 | Término em: 2025. Apartamentos com plantas inteligentes no jd. américa Plantas de 60 a 119 m2 2Q 3Q e 3S Lazer completo Localização excelente Condições de preço de lançamento *Garanta já sua unidade",
    description2:
    <a href="https://wa.link/50ikrh" target={"_blank"}
         style={{
          position:"fixed",
          width:"60px",
          height:"60px",
